...
public class ChargeAddressObject extends ServiceUtils {
    ...
    public static Address getOneAddress () {
        return Address.builder()
                .id(UtilsForTest.uuidNonAutogenerated())
    ...
    public static Address getOneEmptyAddress () {
        return Address.builder()
                .id(UtilsForTest.uuidNonAutogenerated())
                .street(ConstantVariables.EMPTY_STRING)
                .neighborhood(ConstantVariables.EMPTY_STRING)
                .zipcode(ConstantVariables.EMPTY_STRING)
                .city(ConstantVariables.EMPTY_STRING)
                .state(ConstantVariables.EMPTY_STRING)
                .country(ConstantVariables.EMPTY_STRING)
                .latitude(ConstantVariables.EMPTY_STRING)
                .longitude(ConstantVariables.EMPTY_STRING)
                .build();
    }
    ...
    public static AddressEnriched getOneEmptyAddressEnriched () {
        return AddressEnriched.builder()
                .address(getOneEmptyAddress())
                .streetNumber(ConstantVariables.EMPTY_STRING)
                .build();
    }
